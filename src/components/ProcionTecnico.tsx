...
export default function ProcionTecnico() {
        ...
        <div className="rounded-xl border border-border bg-card shadow-2xl shadow-black/50 overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row min-h-[420px]">
            ...
            <div className="w-full md:w-[260px] border-b md:border-b-0 md:border-r border-border p-5 flex flex-col gap-5">
              <div>
                <h2 className="text-sm font-semibold text-foreground mb-0.5">Painel Técnico</h2>
                <p className="text-[11px] text-muted-foreground leading-snug">
                  Use este ID para que o administrador possa gerenciar o suporte.
                </p>
              </div>
              ...
              {/* Password */}
              <div className="space-y-1">
                <span className="text-[11px] text-muted-foreground border-l-2 border-secondary pl-2">Senha de acesso</span>
            ...
            <div className="flex-1 flex flex-col p-5">
              ...
              <div className="flex flex-col items-center gap-3 mb-6">
                <h3 className="text-sm font-semibold text-foreground">Acessar Cliente Remoto</h3>
                <Input
              ...
              <div className="flex-1 flex flex-col items-center justify-center text-center gap-3 py-8">
                ...
                <div>
                  <p className="text-sm text-muted-foreground">Ops, não há atendimentos recentes!</p>
                  <p className="text-xs text-muted-foreground/70">Histórico de suporte vazio.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between px-4 py-2 border-t border-border bg-muted/20">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-medium text-muted-foreground">
                {attendingTechnician ? "Conectado ao cliente" : label}
              </span>
            </div>
            {attendingTechnician && (
              <span className="text-[10px] text-muted-foreground font-medium flex items-center gap-1.5">
                <Users className="h-3 w-3" />
                Atendendo: {attendingTechnician}
              </span>
            )}
          </div>
        </div>
